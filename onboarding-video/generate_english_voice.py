...
script='Upload your video. Let AI find the highlights. Choose your improvements. Preview and download your new cut.'
...
with concurrent.futures.ThreadPoolExecutor(max_workers=2) as pool:
 list(pool.map(lambda p:generate(*p),[('English_Graceful_Lady','english')]))
