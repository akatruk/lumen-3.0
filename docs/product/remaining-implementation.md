...
| Music | Licensed uploads, AI sample-based selection, volume curve, fades, ducking, rhythm estimates, track alignment and reviewable multi-cut beat alignment | Cut shifts are bounded and skip speech, locks, overlays and discontinuous source cuts |
...
| Platform adaptation | Five platforms, per-platform duration ceilings, editable segments/title/copy/CTA, 4 aspect ratios, cover timestamp, video/captions/package export | Shorts capped at 180 seconds and square/portrait; full-frame fit/padding; no automatic publishing or comprehensive platform-policy guarantees |
