...
| Platform adaptation | Five platforms, per-platform duration ceilings, editable segments/title/copy/CTA, 4 aspect ratios, editable hook/closing CTA overlays (style, position, timing), cover timestamp, video/captions/package export | Shorts capped at 180 seconds and square/portrait; full-frame fit/padding; no automatic publishing or comprehensive platform-policy guarantees |
